...
string(REGEX MATCH "DEPENDS mimalloc VERSION ([^ \")]+)" _basics_mimalloc_version_match "${_basics_cmakelists_contents}")
if (NOT CMAKE_MATCH_1)
  message(FATAL_ERROR "Failed to parse Basics mimalloc version from ${_basics_cmakelists}")
endif()
set(BASICS_RELEASE_MIMALLOC_VERSION "${CMAKE_MATCH_1}")
...
set(BASICS_PACKAGE_MIMALLOC_DEPENDS "DEPENDS mimalloc VERSION ${BASICS_RELEASE_MIMALLOC_VERSION}")
...
set(
  ...
  "SG14::SG14 aegis::aegis bitsery::bitsery gxhash::gxhash itoa::itoa libcurl::libcurl libssh2::libssh2 liburing::liburing::static openssl static_type_info::static_type_info"
)
